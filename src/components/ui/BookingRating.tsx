...
const BookingRating = () => {
  return (
    <>
      <Link
        to="https://www.booking.com/hotel/np/moonlight-kathmandu.en-gb.html?aid=356980&label=gog235jc-1DCAsoqwFCE21vb25saWdodC1rYXRobWFuZHVIM1gDaKsBiAEBmAEJuAEXyAEM2AED6AEBiAIBqAIDuAKQuu-6BsACAdICJGQxM2Q4ZDEyLWI0ODYtNDdmZi05Y2IyLWE3ZDMzZDlhYzllOdgCBOACAQ&sid=92d4f646b70df7ccf9096a36f66af01e&dist=0&keep_landing=1&sb_price_type=total&type=total&"
        target="_blank"
        className={`group mt-8 inline-flex items-center gap-5 rounded-full border border-dark/30 bg-light px-6 py-2 shadow transition-all duration-500 md:mb-0 md:flex-row`}
      >
        <svg
          clip-rule="evenodd"
          fill-rule="evenodd"
        ...
        9.5/10 - Guest Review Awards 2016
      </Link>
    </>
  );
};
