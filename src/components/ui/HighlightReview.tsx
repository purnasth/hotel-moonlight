...
const HighlightReview = () => {
  ...
  return (
    <>
      <div
        className={`transition-1000 fixed bottom-8 right-8 z-40 max-w-xs origin-right bg-light shadow ${visible ? 'translate-x-0 opacity-100' : 'translate-x-[150%] opacity-0'}`}
      >
