...
const articlePageContents: Record<string, ArticleContent> = {
  about: {
    ...
    html: '<div className="relative"><img src="https://hotelmoonlight.com/images/subpackage/HOGxu-b4.jpg" alt="Hotel Moonlight" className="h-72 w-full object-cover sm:h-[50vh] sm:min-h-96 lg:h-[110vh]"/><div className="overlay bg-dark/30" /></div>',
    meta_keywords: '',
    meta_description: '',
  },
  csr: {
    ...
    html: '<div class="relative"><img src="https://hotelmoonlight.com/assets/userfiles/images/garden4.jpg" alt="Hotel Moonlight" class="h-72 w-full object-cover sm:h-[50vh] sm:min-h-96 lg:h-[110vh]"><div class="overlay bg-dark/30"></div></div></div><div class="flex flex-col items-center justify-center"><main class="container mx-auto text-center text-dark pb-0"><section><h2 class="mb-4 text-2xl font-semibold text-green-800">Conserving Energy</h2><ul class="list-disc-inside space-y-2 pl-6"><li>We use power-saving electric bulbs and automatic electric cut-off systems when you leave your room.</li><li>Upgraded generator to reduce diesel consumption.</li></ul><h2 class="mb-4 mt-8 text-2xl font-semibold text-green-800">Water</h2><ul class="list-disc-inside space-y-2 pl-6"><li>Installed a ground water pump to reduce transport of water by tanker (a polluter).</li></ul><h2 class="mb-4 mt-8 text-2xl font-semibold text-green-800">Recycle</h2><ul class="list-disc-inside space-y-2 pl-6"><li>All plastic water bottles, soap, and shampoo containers are recycled.</li><li>Beer, wine, and soft drink bottles are returned to bottlers for reuse/recycle.</li><li>Food waste is sorted from \'dry waste\' and offered to farmers as pig food.</li><li>Dry waste is recycled or disposed of via municipality service.</li></ul><h2 class="mb-4 mt-8 text-2xl font-semibold text-green-800">Other Efforts</h2><ul class="list-disc-inside space-y-2 pl-6"><li>Use low-lead paint to reduce harmful effects of lead in the environment.</li><li>Garden spaces to contribute oxygen back to the city.</li></ul></section><section class="mt-8"><h2 class="mb-4 text-2xl font-semibold text-blue-800">Social Awareness</h2><ul class="list-disc-inside space-y-2 pl-6"><li><span class="font-semibold">Home and Family:</span> An inclusive and progressive social welfare program for staff.</li><li>Old furniture, electronics, and materials are repaired and donated to the needy and their families.</li><li>Local welfare organizations receive donations or free/reduced cost use of our conference hall.</li><li><span class="font-semibold">Supporting Partner:</span> Beni Handicrafts, a recycled waste materials project.<ul class="mt-2 list-disc-inside space-y-1 pl-8"><li>Trains women in tailoring to create fashionable and functional products from waste materials.</li><li>Profits support STEPS social work, including Beni Freedom Kit-Bags (washable sanitary pads).</li></ul></li><li><span class="font-semibold">Mountain People \'Bring a Smile\':</span> Guests are encouraged to bring used clothing or trekking gear for distribution to those in need.</li><li><span class="font-semibold">Your Organization:</span> Hotel Moonlight partners with individuals, institutes, and NGOs to provide support.</li></ul><h2 class="mb-4 text-center text-4xl md:text-6xl text-dark mt-12 md:mt-24">CSR is about Ethics</h2><p class="text-center text-xl mb-4">What are ethics? Doing the right thing naturally.</p></section></main></div>',
    meta_keywords: '',
    meta_description: '',
  },
};
const ArticlePage: React.FC = () => {
  ...
  return (
    <main className="bg-light px-0">
      <h1 className="mx-auto my-10 max-w-3xl px-4 text-center text-3xl leading-snug sm:text-3xl md:text-4xl lg:text-7xl lg:leading-snug">
        {title}
      </h1>
      <p className="mx-auto mb-12 max-w-xl px-4 text-center text-base lg:mb-24">
        {description}
      </p>
      ...
      <div className="flex flex-col items-center justify-center">
        <div className="bg-gradient bottom-0 h-16 w-px xl:h-40" />
        <a
          className="group inline-flex items-center gap-5 rounded-full border-dark/30 bg-white px-6 py-2 shadow transition-all duration-700 md:mb-0 md:flex-row"
          href="https://www.tripadvisor.com/Hotel_Review-g293890-d654253-Reviews-Hotel_Moonlight-Kathmandu_Kathmandu_Valley_Bagmati_Zone_Central_Region.html"
          target="_blank"
        >
          <svg
            viewBox="0 0 24 24"
