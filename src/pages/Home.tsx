      ...
      <main className="px-4">
        ...
        <div className="item-center flex justify-center">
          <Link
            ...
            target="_blank"
            className={`group mt-8 inline-flex items-center gap-5 rounded-full border-dark/30 bg-light px-6 py-2 shadow transition-all duration-500 md:mb-0 md:flex-row`}
          >
            <svg
              clip-rule="evenodd"
              fill-rule="evenodd"
